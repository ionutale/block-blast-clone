export const LEVELS = [
  ...
  { id: 3, goal: { type: 'score', target: 150 }, moves: 9 },
  { id: 4, goal: { type: 'lines', target: 4 }, moves: 12 },
  { id: 5, goal: { type: 'score', target: 200 }, moves: 11 },
  { id: 6, goal: { type: 'lines', target: 5 }, moves: 14 },
  { id: 7, goal: { type: 'score', target: 240 }, moves: 12 },
  { id: 8, goal: { type: 'lines', target: 6 }, moves: 16 },
  { id: 9, goal: { type: 'score', target: 260 }, moves: 13 },
  { id: 10, goal: { type: 'lines', target: 7 }, moves: 18 },
  { id: 11, goal: { type: 'score', target: 280 }, moves: 14 },
  { id: 12, goal: { type: 'lines', target: 8 }, moves: 20 },
  { id: 13, goal: { type: 'score', target: 300 }, moves: 15 },
  { id: 14, goal: { type: 'lines', target: 9 }, moves: 22 },
  { id: 15, goal: { type: 'score', target: 320 }, moves: 16 },
  { id: 16, goal: { type: 'lines', target: 10 }, moves: 24 },
  { id: 17, goal: { type: 'score', target: 340 }, moves: 17 },
  { id: 18, goal: { type: 'lines', target: 12 }, moves: 26 },
  { id: 19, goal: { type: 'score', target: 400 }, moves: 20 },
